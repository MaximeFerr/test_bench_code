...
from Supervisor_v2_1 import Supervisor
...
def main():
    ...
    try:
        ...
        plt.savefig('01-Voltage.svg', format='svg', dpi=300)

        plt.figure(2)
        plt.title("Current Data Points")
        plt.plot(current_data, marker='o', linestyle='none')
        plt.savefig('02-Current.svg', format='svg', dpi=300)
        ...
        plt.savefig('03-Power.svg', format='svg', dpi=300)
